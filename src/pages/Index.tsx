...
export default function Index({ favorites, toggleFavorite, cart, addToCart, removeFromCart, updateQuantity, clearCart }: IndexProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background md:pt-[85px] py-16">
      <Header
        cart={cart}
              ...
              >
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 py-1.5 px-2 -mb-px">
                    <h3 className="font-heading text-white text-xl md:text-2xl leading-tight drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] font-light text-center py-0 my-2.5">{category.name}</h3>
                  </div>
                </div>
              </div>
            ))}
