...
export function Header({
  ...
  const [showKPSettingsDialog, setShowKPSettingsDialog] = useState(false);
  ...
  return (
    <header className="bg-white shadow-sm fixed top-0 left-0 right-0 z-40 border-b">
      <div className="w-full mx-auto">
        <div className="flex items-center justify-between px-2 md:px-[17px] rounded-none bg-[#ffffff] max-[768px]:landscape:py-1 my-0 py-[11px]">
                    ...
                    <>
                      ...
                      <div className="sticky bottom-0 bg-background border-t pt-4 space-y-3">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button onClick={() => setShowKPSettingsDialog(true)} variant="outline" size="icon" className="border-primary text-primary hover:bg-transparent hover:text-primary">
      ...
      <Sheet open={showKPSettingsDialog} onOpenChange={(open) => {
        setShowKPSettingsDialog(open);
        if (open) {
          setKpAddress('');
