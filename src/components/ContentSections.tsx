        ...
        <div className="container mx-auto px-0">
          <div className="grid md:grid-cols-2 gap-12 items-center px-3 my-0">
            <div className="animate-fade-in px-3">
              ...
              <p className="text-muted-foreground mb-4 text-base">Мы специализируемся на производстве детского игрового и спортивного оборудования на протяжении 5 лет. За это время мы оснастили более 300 детских площадок по ЮФО.</p>
      ...
      <section id="certificates" className="bg-white py-5">
        <div className="container mx-auto py-0 px-3">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-base my-0">Вся продукция сертифицирована и соответствует стандартам качества</p>
          </div>
      ...
      <footer id="contacts" className="px-0 bg-muted/30 mt-3.5 mb-0 py-[1px]">
        <div className="container mx-auto px-6">
          <div className="text-center py-0 my-12">
            <h2 className="font-heading font-semibold mb-2 text-3xl">Контакты</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10">
            ...
            <div className="flex flex-col gap-4 my-0 mx-0 items-start">
              ...
              <Button
                ...
                className="h-9 bg-transparent border-2 border-primary text-primary font-semibold transition-all duration-300 hover:bg-primary hover:text-white hover:border-primary hover:shadow-lg hover:scale-105"
