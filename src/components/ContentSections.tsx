      ...
      <Dialog open={isPrivacyOpen} onOpenChange={setIsPrivacyOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="text-sm text-muted-foreground space-y-4">
            ...
            <p>12.1. Пользователь может получить разъяснения по вопросам обработки его Персональных данных, обратившись по электронной почте <a href="mailto:info@mafkrasnodar.ru" className="text-primary hover:underline">info@mafkrasnodar.ru</a></p>
