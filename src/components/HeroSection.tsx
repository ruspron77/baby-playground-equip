...
export function HeroSection({ onOpenCatalog }: HeroSectionProps) {
  return (
    <section id="hero" className="relative pt-0 pb-2 md:pb-4 overflow-hidden min-h-[225px] md:min-h-[400px]">
      ...
      <div className="container relative z-10 md:my-[93px] mx-0 my-0 px-[7px]">
        <div className="max-w-3xl animate-fade-in">
          <h2 className="md:text-4xl lg:text-6xl font-heading md:mb-6 text-white font-semibold mx-0 py-0 text-xl my-2.5 px-0">
            Создаём пространство для игры и спорта
          </h2>
          <p className="md:text-xl text-white/90 md:mb-8 my-0 py-0 font-normal text-left text-sm px-0">
          ...
          <div className="flex flex-wrap gap-4 my-0 px-0">
