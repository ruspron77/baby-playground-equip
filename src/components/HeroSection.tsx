  ...
  return (
    <section id="hero" className="relative pt-0 pb-2 md:pb-4 overflow-hidden min-h-[225px] md:min-h-[400px]">
      <div 
        ...
        style={{ 
          backgroundImage: 'url(https://cdn.poehali.dev/projects/ffd62df4-6e6a-420c-99f5-4d24cf68fcf3/bucket/d0d33c74-0dd7-4efb-ada8-1fe25973c31c.png)',
      ...
      <div className="container mx-auto px-4 relative z-10 md:my-[93px] my-[42px]">
