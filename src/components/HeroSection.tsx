...
export function HeroSection({ onOpenCatalog }: HeroSectionProps) {
  return (
    <section id="hero" className="relative pt-0 pb-2 md:pb-4 overflow-hidden min-h-[225px] md:min-h-[400px]">
      ...
      <div className="w-full relative z-10 md:my-[93px] mx-0 my-0 py-0">
        <div className="max-w-3xl animate-fade-in px-2 mx-0 md:ml-[50px] py-0 my-0">
          ...
          <p className="md:text-xl text-white/90 md:mb-8 py-0 font-normal mx-0 px-0.5 md:px-0 text-left text-sm my-0">
          ...
          <div className="flex flex-wrap gap-4 mx-0 px-0 py-0 my-3.5">
