...
export function HeroSection({ onOpenCatalog }: HeroSectionProps) {
  return (
    <section id="hero" className="relative md:pb-4 overflow-hidden min-h-[500px] md:min-h-[400px] my-0 py-0">
      <div 
        className="absolute inset-0 mx-0 py-0 my-0 hidden md:block"
        style={{ 
      ...
      >
        <div className="absolute inset-0 px-0 mx-0 py-0 bg-[#0000001c] rounded-0 my-[247px]"></div>
      </div>
      ...
      <div className="w-full relative z-10 md:my-[93px] mx-0 py-0 my-[102px]">
        <div className="max-w-3xl animate-fade-in mx-0 md:ml-[50px] px-[7px] my-0 py-0">
          ...
          <p className="md:text-xl text-white/90 md:mb-8 font-normal mx-0 px-0.5 md:px-0 text-left text-base py-0 my-8">Производим качественное детское игровое, спортивное и парковое оборудование. Безопасность, долговечность и яркий дизайн — наши главные приоритеты.</p>
          <div className="flex flex-wrap gap-4 mx-0 px-0 py-0 my-[92px]">
