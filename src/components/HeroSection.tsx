...
export function HeroSection({ onOpenCatalog }: HeroSectionProps) {
  return (
    <section id="hero" className="relative md:pb-4 overflow-hidden min-h-[500px] md:min-h-[400px] my-3 py-0">
      <div 
        className="absolute inset-0 py-0 mx-0 px-0 my-[73px]"
        style={{ 
      ...
      >
        <div className="absolute inset-0 px-0 mx-0 py-0 bg-[#0000001c] my-[62px]"></div>
      </div>
      ...
      <div className="w-full relative z-10 md:my-[93px] mx-0 py-0 my-[102px]">
        <div className="max-w-3xl animate-fade-in mx-0 md:ml-[50px] px-[7px] my-0 py-0">
          <h2 className="md:text-4xl lg:text-6xl font-heading md:mb-6 text-white font-semibold px-0 mx-0 py-[18px] my-0 text-3xl">
          ...
          <div className="flex flex-wrap gap-4 mx-0 px-0 py-0 my-1.5">
