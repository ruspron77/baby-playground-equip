        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted p-4 rounded-lg space-y-2 text-sm">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <li>Структура: Картинка, Категория, Подкатегория, Подподкатегория, Артикул, Название, Размеры, Цена</li>
              <li>Первая строка должна содержать заголовки</li>
              <li>Подкатегории можно оставлять пустыми (будут объединены через " > ")</li>
