...
export function CategoryGrid({
  ...
  return (
    <div id="products" className="container mx-auto pt-0 px-0">
      <div ref={filtersRef}>
        <div className="fixed top-[76px] md:top-[85px] left-0 right-0 bg-gray-50 z-[60] px-4 shadow-md border-b border-gray-200 py-1 transition-all duration-300" style={{ top: 'var(--filters-top, 76px)' }}>
        ...
        <div ref={productsRef} className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 px-3 py-2.5 pb-[60vh] sm:pb-2 pt-[100px] sm:pt-[60px]">
          {(() => {
