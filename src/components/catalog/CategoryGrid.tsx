...
export function CategoryGrid({
  ...
  return (
    <div id="products" className="container mx-auto pt-0 px-0">
      <div ref={filtersRef}>
        <div className={`fixed top-[76px] md:top-[85px] left-0 right-0 z-[60] shadow-md border-t border-b border-gray-200 transition-all duration-300 px-2.5 py-2.5 md:py-1.5 bg-[#ffffff] ${isProductDialogOpen ? 'hidden' : ''}`} style={{ top: 'var(--filters-top, 76px)' }}>
        ...
        <div ref={productsRef} className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 px-3 sm:pt-20 py-[175px]">
          {(() => {
