...
export function ServicesSection() {
  ...
  return (
    <section id="services" className="bg-muted/30 order-1 md:order-1 my-[9px] py-0">
      <div className="container mx-auto px-3 py-4 my-0">
        <h2 className="text-2xl font-bold text-center py-0 my-0">Услуги</h2>
        <p className="text-center text-muted-foreground py-[13px] my-0">Полный цикл — от проектирования до монтажа</p>
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 my-0 py-[19px]">
