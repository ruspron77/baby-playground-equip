          ...
          {selectedCategory && (
            <div id="products" className="container mx-auto px-4">
              <div>
                ...
                <div className="sticky top-[85px] bg-white z-40 pb-4 pt-4 -mx-4 px-4">
              ...
              <div ref={productsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-16">
