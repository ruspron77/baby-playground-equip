...
export function KPDialog({ open, onOpenChange }: KPDialogProps) {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: "КП будет отправлено на указанную почту в ближайшее время",
        });
      } else {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Заполните форму и мы отправим коммерческое предложение на вашу почту
          </p>
        </DialogHeader>
